...
import { deleteFolderRecursive, JovoCliPreset, JovoUserConfig, JovoUserConfigFile } from '../src';
...
describe('getPresets()', () => {
  test('should return presets', () => {
    ...
    const config: JovoUserConfig = new JovoUserConfig();
    const presets: JovoCliPreset[] = config.getPresets();
...
describe('getPreset()', () => {
  test('should return correct preset', () => {
    ...
    const config: JovoUserConfig = new JovoUserConfig();
    const preset: JovoCliPreset = config.getPreset('presetName');
